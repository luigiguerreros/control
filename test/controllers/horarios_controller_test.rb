...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { curso: @horario.curso, h_entrada: @horario.h_entrada, h_salida: @horario.h_salida, personal: @horario.personal }
    end
  ...
  test "should update horario" do
    patch :update, id: @horario, horario: { curso: @horario.curso, h_entrada: @horario.h_entrada, h_salida: @horario.h_salida, personal: @horario.personal }
    assert_redirected_to horario_path(assigns(:horario))
  end
