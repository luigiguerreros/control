...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: { encargado: @area.encargado, nombre: @area.nombre, telefono: @area.telefono }
    end
  ...
  test "should update area" do
    patch :update, id: @area, area: { encargado: @area.encargado, nombre: @area.nombre, telefono: @area.telefono }
    assert_redirected_to area_path(assigns(:area))
  end
